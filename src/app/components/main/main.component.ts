  ...
  sections: Section[] = [
    {
      ...
      entries: [
        ...
        },
        {
          ...
          rightContent:
            'Worked on a MVNE project enabling mobile virtual network operators to offer services to their own customers.',
          rightContentList: [
        ...
        },
        {
          ...
          rightContent:
            'Help deliver a modern SaaS FinTech Platform designed for the Cloud and focused on providing financial technology for MFIs, small banks and other organizations.',
          rightContentList: [
    ...
    },
    {
      ...
      entries: [
        {
          leftTitle: 'SQLNoir',
          leftLink: 'https://github.com/hristo2612/sqlnoir',
          leftContent: 'Feb. 2025',
          rightTitle: 'React & Tailwind',
          rightContent:
            'A SQL Game where you solve mysteries and crimes made in React, Tailwind',
        },
        {
          leftTitle: 'My Resume',
          ...
          rightContent:
            'It is a static resume website. The one you are reading right now.',
        },
        {
          leftTitle: 'Trillo',
          ...
          rightTitle: 'Angular & SCSS',
          rightContent:
            'A static hotel booking website, implementing responsive design with flexbox.',
        },
        {
          ...
          rightTitle: 'Angular & SCSS',
          rightContent:
            'Website implementing core features of SCSS ( mixins, variables, prefixes, etc. ) and visual design concepts using Angular 12+',
        },
        {
        ...
        },
        {
          ...
          rightContent:
            "An app that let's you track your needs for the day and keeps track of your history throughout time.",
        },
        {
          ...
          rightContent:
            'Add frequently used commands to your list and re-use them in the future, passing custom parameters.',
        },
        {
          ...
          rightTitle: 'Node.js',
          rightContent:
            'Opinionated and customizable boilerplate for automating unit tests in Angular 2+',
        },
        {
          ...
          rightTitle: 'Node.js',
          rightContent:
            'A script that crawls through a given facebook event and finds what percentage of guys & girls are attending ( Not working anymore ).',
        },
        {
          leftTitle: 'LogX',
      ...
      entries: [
        {
          ...
          rightContent:
            'Received a recommendation for my first job due to my exceptionally good grades.',
        },
        {
